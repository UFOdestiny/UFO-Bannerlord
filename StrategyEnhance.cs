...
internal class StrategyAttrEnhance
{
    ...
    internal class CalculateBaseSpeedPostfixPatch
    {
        private static void Postfix(ref ExplainedNumber __result, MobileParty mobileParty, bool includeDescriptions, int additionalTroopOnFootCount, int additionalTroopOnHorseCount)
        {
            ...
            if (num != 0f)
            {
                ...
                __result.Add((float)attributeValue * settings.CunningPartySpeedAdd * num, DefaultCharacterAttributes.Cunning.Name);
            }
        }
    }
    ...
    internal class GetConformityChangePerHourPostfixPatch
    {
        private static void Postfix(ref int __result, PartyBase party, CharacterObject troopToBoost)
        {
            ...
            if (num != 0f)
            {
                ...
                __result = (int)((float)__result * (1f + (float)attributeValue * settings.CunningPrisonerRecruitSpeedPercent * num));
            }
        }
    }
    ...
    internal class AddMobilePartyLeaderPrisonerSizePerkEffectsPostfixPatch
    {
        private static void Postfix(PartyBase party, ref ExplainedNumber result)
        {
            ...
            {
                int attributeValue = leaderHero.GetAttributeValue(DefaultCharacterAttributes.Cunning);
                result.AddFactor((float)attributeValue * settings.CunningPrisonerCapacityPercent * num, DefaultCharacterAttributes.Cunning.Name);
            }
        }
    }
    ...
    internal class CalculateHitDamagePostfixPatch
    {
        ...
        {
            if (UFO.Extensions.StrategyEnhanceDisable())
            {
                return;
            }
            foreach (MapEventParty party in attackerSide.Parties)
            {
                ...
                if (mobileParty != null)
                {
                    ...
                    {
                        int attributeValue = leaderHero.GetAttributeValue(DefaultCharacterAttributes.Cunning);
                        __result *= 1f + (float)attributeValue * settings.CunningRaidSpeedPercent;
                    }
                }
            }
        }
    ...
    internal class DailyTickPartyPostfixPatch
    {
        private static void Postfix(Town town, ref ExplainedNumber explainedNumber)
        {
            if (!UFO.Extensions.StrategyEnhanceDisable())
            {
                ...
                if (num > 0f)
                {
                    num2 = (float)owner.GetAttributeValue(DefaultCharacterAttributes.Social) - settings.SocialBoundary;
                    num2 = ((!(num2 > 0f)) ? (num2 / num) : (num2 * num));
                    explainedNumber.Add(num2 * settings.SocialSettlementLoyaltyAdd, owner.Name);
                }
                Hero governor = town.Governor;
                float num3 = governor.StrategyEnhanceRate();
                if (num3 > 0f)
                {
                    float num4 = (float)governor.GetAttributeValue(DefaultCharacterAttributes.Social) - settings.SocialBoundary;
                    num4 = ((!(num4 > 0f)) ? (num4 / num3) : (num4 * num3));
                    explainedNumber.Add(num4 * settings.SocialSettlementLoyaltyAdd, governor.Name);
                }
                else if (num > 0f)
                {
                    explainedNumber.Add(num2 * settings.SocialSettlementLoyaltyAdd * 0.5f, owner.Name);
                }
            }
        }
    }
    ...
    internal class CalculateHearthChangeInternalPostfixPatch
    {
        ...
        {
            if (!UFO.Extensions.StrategyEnhanceDisable() && village.Bound != null)
            {
                ...
                if (num > 0f)
                {
                    num2 = (float)owner.GetAttributeValue(DefaultCharacterAttributes.Social) - settings.SocialBoundary;
                    num2 = ((!(num2 > 0f)) ? (num2 / num) : (num2 * num));
                    __result.Add(num2 * settings.SocialHearthAdd, owner.Name);
                }
                ...
                if (num3 > 0f)
                {
                    float num4 = (float)governor.GetAttributeValue(DefaultCharacterAttributes.Social) - settings.SocialBoundary;
                    num4 = ((!(num4 > 0f)) ? (num4 / num3) : (num4 * num3));
                    __result.Add(num4 * settings.SocialHearthAdd, governor.Name);
                }
                else if (num > 0f)
                {
                    __result.Add(num2 * settings.SocialHearthAdd * 0.5f, owner.Name);
                }
            }
        }
    }
    ...
    internal class CalculateMilitiaChangePostfixPatch
    {
        ...
        {
            if (!UFO.Extensions.StrategyEnhanceDisable() && settlement != null)
            {
                ...
                if (num > 0f)
                {
                    num2 = (float)owner.GetAttributeValue(DefaultCharacterAttributes.Social) - settings.SocialBoundary;
                    num2 = ((!(num2 > 0f)) ? (num2 / num) : (num2 * num));
                    __result.Add(num2 * settings.SocialMilitiaAdd, owner.Name);
                }
                Hero hero = null;
                ...
                if (num3 > 0f)
                {
                    float num4 = (float)hero.GetAttributeValue(DefaultCharacterAttributes.Social) - settings.SocialBoundary;
                    num4 = ((!(num4 > 0f)) ? (num4 / num3) : (num4 * num3));
                    __result.Add(num4 * settings.SocialMilitiaAdd, hero.Name);
                }
                else if (num > 0f)
                {
                    __result.Add(num2 * settings.SocialMilitiaAdd * 0.5f, owner.Name);
                }
            }
        }
    }
        ...
        private static void Postfix(ref int __result, Clan clan)
        {
            if (!UFO.Extensions.StrategyEnhanceDisable())
            {
                ...
                if (num != 0f)
                {
                    ...
                    __result += (int)((float)attributeValue * settings.CunningCompanionCapacityAdd * num);
                    int attributeValue2 = leader.GetAttributeValue(DefaultCharacterAttributes.Social);
                    __result += (int)((float)attributeValue2 * settings.SocialCompanionCapacityAdd * num);
                }
            }
        }
    }
    ...
    internal class GetDailyVolunteerProductionProbabilityPostfixPatch
    {
        private static void Postfix(ref float __result, Settlement settlement)
        {
            if (!UFO.Extensions.StrategyEnhanceDisable())
            {
                ...
                if (num2 > 0f)
                {
                    num3 = (float)owner.GetAttributeValue(DefaultCharacterAttributes.Social) - settings.SocialBoundary;
                    num3 = ((!(num3 > 0f)) ? (num3 / num2) : (num3 * num2));
                    num += num3 * settings.SocialRecruitSpeedPercent;
                }
                Hero hero = null;
                if (settlement.IsVillage)
                {
                ...
                if (num4 > 0f)
                {
                    float num5 = (float)hero.GetAttributeValue(DefaultCharacterAttributes.Social) - settings.SocialBoundary;
                    num5 = ((!(num5 > 0f)) ? (num5 / num4) : (num5 * num4));
                    num += num5 * settings.SocialRecruitSpeedPercent;
                }
                else if (num2 > 0f)
                {
                    num += num3 * settings.SocialRecruitSpeedPercent * 0.5f;
                }
                __result *= num;
            }
        }
    ...
    internal class CalculateTownTaxPostfixPatch
    {
        ...
        {
            if (UFO.Extensions.StrategyEnhanceDisable() || (!town.IsTown && !town.IsCastle))
            {
                return;
            }
            Hero governor = town.Governor;
            ...
            if (num > 0f)
            {
                float num2 = (float)governor.GetAttributeValue(DefaultCharacterAttributes.Social) - settings.SocialBoundary;
                num2 = ((!(num2 > 0f)) ? (num2 / num) : (num2 * num));
                __result.AddFactor(num2 * settings.SocialTaxPercent, governor.Name);
            }
            else if (town.Settlement.Owner != null)
            {
                ...
                if (num3 > 0f)
                {
                    float num4 = (float)owner.GetAttributeValue(DefaultCharacterAttributes.Social) - settings.SocialBoundary;
                    num4 = ((!(num4 > 0f)) ? (num4 / num3) : (num4 * num3));
                    __result.AddFactor(num4 * settings.SocialTaxPercent * 0.5f, owner.Name);
                }
            }
        }
    }
    ...
    public static class GetTotalWagePostfixPatch
    {
        ...
        {
            if (UFO.Extensions.StrategyEnhanceDisable() || !mobileParty.IsGarrison)
            {
                return;
            }
            ...
            if (num > 0f)
            {
                float num2 = (float)governor.GetAttributeValue(DefaultCharacterAttributes.Intelligence) - settings.IntelligenceBoundary;
                num2 = ((!(num2 > 0f)) ? (num2 / num) : (num2 * num));
                __result.AddFactor(num2 * (0f - settings.IntelligenceGarrisonWageReducePercent), governor.Name);
            }
            else if (currentSettlement.Owner != null)
            {
                ...
                if (num3 > 0f)
                {
                    float num4 = (float)currentSettlement.Owner.GetAttributeValue(DefaultCharacterAttributes.Intelligence) - settings.IntelligenceBoundary;
                    num4 = ((!(num4 > 0f)) ? (num4 / num3) : (num4 * num3));
                    __result.AddFactor(num4 * (0f - settings.IntelligenceGarrisonWageReducePercent) * 0.5f, currentSettlement.Owner.Name);
                }
            }
        }
    }
    ...
    internal class GetEffectiveConversionSpeedOfProductionPostfixPatch
    {
        private static void Postfix(ref DefaultWorkshopModel __instance, ref ExplainedNumber __result, ref Workshop workshop, ref float speed, ref bool includeDescription)
        {
            ...
            if (num2 > 0f)
            {
                float num3 = (float)governor.GetAttributeValue(DefaultCharacterAttributes.Social) - settings.SocialBoundary;
                num3 = ((!(num3 > 0f)) ? (num3 / num2) : (num3 * num2));
                num += num3 * settings.SocialWorkshopProductionPercent;
            }
            else if (settlement.Owner != null)
            {
                ...
                if (num4 > 0f)
                {
                    float num5 = (float)settlement.Owner.GetAttributeValue(DefaultCharacterAttributes.Social) - settings.SocialBoundary;
                    num5 = ((!(num5 > 0f)) ? (num5 / num4) : (num5 * num4));
                    num += num5 * settings.SocialWorkshopProductionPercent * 0.5f;
                }
            }
            if (workshop.Owner != null)
            {
                ...
                if (num6 > 0f)
                {
                    float num7 = (float)workshop.Owner.GetAttributeValue(DefaultCharacterAttributes.Intelligence) - settings.IntelligenceBoundary;
                    num7 = ((!(num7 > 0f)) ? (num7 / num6) : (num7 * num6));
                    num += num7 * settings.IntelligenceWorkshopProductionPercent;
                }
            }
            if (num != 0f)
            {
    ...
    internal class AddSkillXpPrefixPatch
    {
        ...
        {
            if (settings.TestMode && (skill.CharacterAttribute == DefaultCharacterAttributes.Vigor || skill.CharacterAttribute == DefaultCharacterAttributes.Control || skill.CharacterAttribute == DefaultCharacterAttributes.Endurance))
            {
                xpAmount = 0f;
            }
            ...
            float num2 = (float)attributeValue * settings.IntelligenceExpRate * num;
            float num3 = 1f + num2;
    ...
    internal class GainRawXpPrefixPatch
    {
        private static bool Prefix(ref HeroDeveloper __instance, ref float rawXp)
        {
            ...
            rawXp *= 1f + (float)attributeValue * settings.IntelligenceExpRate * num;
            return true;
        }
    }
    ...
    internal class CalculateTownFoodStocksChangePostfixPatch
    {
        private static void Postfix(ref DefaultSettlementFoodModel __instance, ref ExplainedNumber __result, ref Town town)
        {
            ...
            if (num > 0f)
            {
                num2 = (float)owner.GetAttributeValue(DefaultCharacterAttributes.Intelligence) - settings.IntelligenceBoundary;
                num2 = ((!(num2 > 0f)) ? (num2 / num) : (num2 * num));
                __result.Add(num2 * settings.IntelligenceLeaderSettlementFoodPercent, owner.Name);
            }
            ...
            if (num5 > 0f)
            {
                ...
                num3 += num3 * num4;
                float num6 = (float)governor.GetAttributeValue(DefaultCharacterAttributes.Intelligence) - settings.IntelligenceBoundary;
                num6 = ((!(num6 > 0f)) ? (num6 / num5) : (num6 * num5));
                __result.Add(num6 * settings.IntelligenceGovernorSettlementFoodPercent, governor.Name);
                float value = (0f - num3) * num6 * settings.IntelligenceProsperityFoodCostReducePercent + num6 * 1f;
                __result.Add(value, governor.Name);
            }
            else if (num > 0f)
            {
                float value2 = ((0f - num3) * num2 * settings.IntelligenceProsperityFoodCostReducePercent + num2 * 1f) * 0.5f;
    ...
    internal class GetPrebuiltSiegeEnginesOfSettlementPostfixPatch
    {
        private static void Postfix(ref IEnumerable<SiegeEngineType> __result, ref Settlement settlement)
        {
            ...
            if (num2 > 0f)
            {
                num = (int)((float)governor.GetAttributeValue(DefaultCharacterAttributes.Intelligence) * settings.IntelligenceBallistaAdd * num2);
            }
            else if (settlement.Owner != null)
            {
                ...
                if (num3 > 0f)
                {
                    num = (int)((float)settlement.Owner.GetAttributeValue(DefaultCharacterAttributes.Intelligence) * settings.IntelligenceBallistaAdd * num3 * 0.5f);
                }
            }
            if (num > 0)
            {
    ...
    internal class GetPrebuiltSiegeEnginesOfSiegeCampPostfixPatch
    {
        private static void Postfix(ref IEnumerable<SiegeEngineType> __result, ref BesiegerCamp besiegerCamp)
        {
            ...
            {
                List<SiegeEngineType> list = (List<SiegeEngineType>)__result;
                int num2 = (int)((float)effectiveEngineer.GetAttributeValue(DefaultCharacterAttributes.Intelligence) * settings.IntelligenceBallistaAdd * num);
                while (num2-- > 0)
                {
                    list.Add(DefaultSiegeEngineTypes.Ballista);
                }
        ...
        private static void Postfix(ref DefaultSiegeEventModel __instance, ref float __result, ref SiegeEvent siegeEvent, ref SiegeEngineType siegeEngine, ref BattleSideEnum battleSide)
        {
            ...
            if (battleSide == BattleSideEnum.Defender)
            {
                if (besiegedSettlement.Town.Governor != null)
                {
                    ...
                    if (num > 0f)
                    {
                        ...
                        __result *= 1f + (float)attributeValue * settings.IntelligenceSiegeEndurancePercent * num;
                    }
                }
                else if (besiegedSettlement.Owner != null)
                {
                    ...
                    if (num2 > 0f)
                    {
                        ...
                        __result *= 1f + (float)attributeValue2 * settings.IntelligenceSiegeEndurancePercent * num2 * 0.5f;
                    }
                }
            }
            else if (battleSide == BattleSideEnum.Attacker && effectiveSiegePartyForSide != null)
            {
                ...
                if (num3 > 0f)
                {
                    ...
                    __result *= 1f + (float)attributeValue3 * settings.IntelligenceSiegeEndurancePercent * num3;
                }
            }
        }
    }
        ...
        private static void Postfix(ref float __result, ref Town town)
        {
            ...
            if (town.Governor != null)
            {
                ...
                if (num > 0f)
                {
                    ...
                    __result *= 1f + (float)attributeValue * settings.IntelligenceWallEndurancePercent * num;
                }
            }
            else if (town.Settlement.Owner != null)
            {
                ...
                if (num2 > 0f)
                {
                    ...
                    __result *= 1f + (float)attributeValue2 * settings.IntelligenceWallEndurancePercent * num2 * 0.5f;
                }
            }
        }
    }
