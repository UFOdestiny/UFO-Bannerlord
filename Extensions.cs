...
namespace UFO
{
    public static class Extensions
    {
        ...
        public static int AgeScale(this Hero hero)
        {
            ...
            if (settings.EnableEverYoung && hero == Hero.MainHero)
            {
                return -1;
            }
            ...
            int num2 = 2;
            if (num >= settings.EverYoungSkillNeed)
            {
                return -1;
            }
            if (!hero.IsWanderer)
        ...
        {
            return settings.CombatAttributeRatePlayer == 0f && settings.CombatAttributeRateClanMember == 0f && settings.CombatAttributeRateOther == 0f;
        }

        public static bool StrategyEnhanceDisable()
        {
            return settings.StrategyAttributeRatePlayer == 0f && settings.StrategyAttributeRateClanMember == 0f && settings.StrategyAttributeRateOther == 0f;
        }
        ...
        public static float CombatEnhanceRate(this Hero hero)
        {
            ...
            {
                return settings.CombatAttributeRatePlayer;
            }
            if (hero.Clan == Clan.PlayerClan)
            {
                return settings.CombatAttributeRateClanMember;
            }
            return settings.CombatAttributeRateOther;
        }
        ...
        public static float StrategyEnhanceRate(this Hero hero)
        {
            ...
            if (hero == Hero.MainHero)
            {
                return settings.StrategyAttributeRatePlayer;
            }
            if (hero.Clan == Clan.PlayerClan)
            {
                return settings.StrategyAttributeRateClanMember;
            }
            return settings.StrategyAttributeRateOther;
        }
        ...
        {
            if (!hero.IsAlive || settings.AutoChoosePerk.SelectedIndex > hero.EnhanceType())
            {
                return;
            }
            foreach (PerkObject item in PerkObject.All)
            {
                ...
                if ((float)hero.GetSkillValue(skill) >= item.RequiredSkillValue && !hero.GetPerkValue(item))
                {
